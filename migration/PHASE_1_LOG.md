...
### Pendentes
- **#26–#27** — primitivos restantes (Card, Badge/Avatar/Chip), seguem o mesmo padrão fixado pela #24/#25 (pasta própria, story com autodocs, teste).

Ao final da Fase 1, quase nenhuma tela do sistema terá mudado (exceto o fundo/texto base já aplicado pela #20, e a limpeza pontual de `login/page.tsx` feita durante a #25) — a Fase 2 é quando essas peças passam a ser efetivamente usadas, feature por feature, começando pela mais simples.