...
export function AlertItem({ title, subtitle, color = '#E86C88', children }: AlertItemProps) {
  ...
  return (
    <div className="rounded-[14px] bg-[#FFFDF9] shadow-[0_2px_8px_rgba(180,140,120,0.12)] overflow-hidden">
      ...
      {/* Conteúdo expandido */}
      {open && children && <div className="px-4 pb-3 border-t border-[#F0EAE4]">{children}</div>}
    </div>
  )
}
