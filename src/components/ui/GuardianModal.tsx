...
const relationOptions: GuardianRelation[] = ['mae', 'pai', 'ava', 'avo', 'tia', 'tio', 'outro']
...
// ── Modal ─────────────────────────────────────────────────────
export function GuardianModal({ schoolId, userId, childId, onClose, onSaved }: GuardianModalProps) {
  ...
  function validate() {
    ...
    if (!existingGuardian && !phone.replace(/\D/g, '')) e.phone = 'Telefone é obrigatório'
      ...
      >
        ...
        {step === 'cpf' && (
          <div className="flex flex-col gap-4">
            <h2 className="font-display text-lg font-bold text-[#3A2E24]">Cadastrar responsável</h2>
            ...
            <Button variant="primary" loading={searching} onClick={handleVerifyCpf}>
              Continuar
            </Button>
          ...
          <div className="flex flex-col gap-4">
            ...
            {existingGuardian ? (
              <div className="p-3 rounded-[14px] bg-[#EDF7ED] border border-[#72AA78]/20">
                <p className="text-sm text-[#72AA78] font-medium">✓ Responsável já cadastrado</p>
                <p className="text-xs text-[#8C7060] mt-0.5">Só é necessário vincular à criança.</p>
              </div>
            ) : (
              <>
                <Input
            ...
            {!childId && (
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  "
                />
                {errors.child && <span className="text-xs text-[#E86C88]">{errors.child}</span>}
            ...
            <div className="flex flex-col gap-2">
              ...
              {errors.relation && <span className="text-xs text-[#E86C88]">{errors.relation}</span>}
            </div>
              ...
              <div className="p-4 rounded-[14px] bg-[#FAF7F2] border border-[#E8E0D8]">
                <p className="text-sm text-[#3A2E24]">
                  ...
                  {selectedChild && (
                    <>
                      {' '}
                      de <span className="font-semibold">{selectedChild.name}</span>
                    </>
                  )}
                  .
                </p>
            ...
            {inviteLink ? (
              <>
                <p className="text-sm text-[#8C7060]">
                  Copie o link abaixo e envie para o responsável pelo WhatsApp. O link expira em 72
                  horas.
                </p>
              ...
              <p className="text-sm text-[#8C7060]">
                O responsável já tem acesso ao sistema. A nova criança aparecerá no feed dele
                automaticamente.
              </p>
            )}
